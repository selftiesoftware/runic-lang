...
//
//class ImportTest extends FlatSpec with MockFactory with Matchers with BeforeAndAfterEach {
//  this: Suite =>
//
...
//      val mockParser = new Parser(mockClient, Environment.parserEnv, TokenLexer.lex)
...
//    val newParser = new Parser(mockClient2, ParserEnv(), TokenLexer.lex)
...
//    val mockClient2 = stub[HttpClient]
//    val newParser = new Parser(mockClient2, Environment.parserEnv, TokenLexer.lex(_, toLowerCase = true))
